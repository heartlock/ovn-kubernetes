...
import (
	...
	cmdutil "k8s.io/kubernetes/pkg/kubeovnctl/cmd/util"
...
func NewKubeovnctlCommand(f *cmdutil.Factory, in io.Reader, out, err io.Writer) *cobra.Command {
...
Find more information at https://github.com/kubernetes/kubernetes.`,
	...
	cmds.AddCommand(NewCmdMasterinit(f, out))
	cmds.AddCommand(NewCmdMinioninit(f, out))
	cmds.AddCommand(NewCmdGatewayinit(f, out))
